    ...
    <article>
      ...
      <section class="section shop" id="shop" aria-label="shop"
        ...
        <div class="container">
          ...
          <h2 class="h2 section-title">
            Personajes <span class="span">-Mario Bros</span>
          </h2>

          <p class="section-text">
          En este anexo se enlistan a los personajes que aparecen en la serie de videojuegos de la franquicia de Mario Kart Deluxe.
          Presiona "Ver más"
          </p>
          ...
          <ul class="has-scrollbar">
            ...
            <li class="scrollbar-item">
              <div class="shop-card">
                ...
                <img src="{{asset('assets/peachstyle/img/peach11.jpg')}}" width="300" height="260" loading="lazy"
                    alt="Women Black T-Shirt" class="img-cover">
                </figure>

                <div class="card-content">

                  <a href="#" class="card-badge skewBg">Peach</a>

                  <h3 class="h3">
                    <a href="{{ url('/peach') }}" class="card-title">Ver más</a>
                  </h3>

                  <div class="card-wrapper">
                    <p class="card-price">Hola! Soy la princesa del Reino Champiñón</p>
            ...
            <li class="scrollbar-item">
              <div class="shop-card">
                ...
                <figure class="card-banner img-holder" style="--width: 300; --height: 260;">
                <img src="{{asset('assets/peachstyle/img/waluigi.jpg')}}" width="300" height="260" loading="lazy"
                    alt="Gears 5 Xbox Controller" class="img-cover">
                </figure>

                <div class="card-content">

                  <a href="#" class="card-badge skewBg">Waluigi</a>

                  <h3 class="h3">
                  <a href="{{ url('/waluigi2') }}" class="card-title">Ver más</a>
                  </h3>

                  <div class="card-wrapper">
                    <p class="card-price">Rival de Luigi y el compañero de Wario.</p>
            ...
            <li class="scrollbar-item">
              <div class="shop-card">
                ...
                <figure class="card-banner img-holder" style="--width: 300; --height: 260;">
                <img src="{{asset('assets/peachstyle/img/bowser.png')}}" width="300" height="260" loading="lazy"
                    alt="GeForce RTX 2070" class="img-cover">
                </figure>

                <div class="card-content">

                  <a href="#" class="card-badge skewBg">Bowser</a>

                  <h3 class="h3">
                    <a href="{{ url('/bowser2') }}" class="card-title">Ver más</a>
                  </h3>

                  <div class="card-wrapper">
                    <p class="card-price">Rey y el más poderoso de los Koopas.</p>
            ...
            <li class="scrollbar-item">
              <div class="shop-card">
                ...
                <div class="card-content">
                  ...
                  <a href="#" class="card-badge skewBg">Link </a>

                  <h3 class="h3">
                    <a href="{{ url('/link2') }}" class="card-title">Ver más</a>
                  </h3>

                  <div class="card-wrapper">
                    <p class="card-price">Link como personaje jugable y la moto Hyliana.</p>
